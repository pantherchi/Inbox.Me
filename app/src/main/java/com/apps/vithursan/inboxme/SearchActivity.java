            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()){
                    case R.id.action_cancel:
                        SearchHandler.getInstance(getApplicationContext()).clearData();
                        finish();
                }
                return true;
            }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!jsonObject.getBoolean("error")){
                        SearchHandler.getInstance(getApplicationContext()).getData(jsonObject.getInt("id"), jsonObject.getString("action"), jsonObject.getString("username"));
//                        Toast.makeText(getApplicationContext(),jsonObject.getString("message"),Toast.LENGTH_SHORT).show();
    ...
    private void parseData() {
        tvItem.setText(SearchHandler.getInstance(this).getUsername());
        final String action = SearchHandler.getInstance(this).getKeyAction();
    ...
    private void queryRelations() {
        ...
        final String user_two = String.valueOf(SearchHandler.getInstance(this).getUserID());
        final String action = SearchHandler.getInstance(this).getKeyAction();
